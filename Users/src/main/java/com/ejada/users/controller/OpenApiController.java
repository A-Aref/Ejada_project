...
public class OpenApiController {
    ...
    public ResponseEntity<String> downloadOpenApiYaml() {
        try {
            ...
            String jsonContent = restTemplate.getForObject("http://localhost:8080/api-docs", String.class);
            ...
            headers.setContentDispositionFormData("attachment", "users-service-openapi.yml");
