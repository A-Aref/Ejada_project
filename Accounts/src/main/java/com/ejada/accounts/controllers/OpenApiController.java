...
public class OpenApiController {
    ...
    public ResponseEntity<String> downloadOpenApiYaml() {
        try {
            ...
            String jsonContent = restTemplate.getForObject("http://localhost:8082/api-docs", String.class);
            ...
            headers.setContentDispositionFormData("attachment", "accounts-service-openapi.yml");
