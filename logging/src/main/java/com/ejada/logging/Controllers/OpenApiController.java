...
public class OpenApiController {
    ...
    public ResponseEntity<String> downloadOpenApiYaml() {
        try {
            ...
            String jsonContent = restTemplate.getForObject("http://localhost:8081/api-docs", String.class);
            ...
            headers.setContentDispositionFormData("attachment", "logging-service-openapi.yml");
