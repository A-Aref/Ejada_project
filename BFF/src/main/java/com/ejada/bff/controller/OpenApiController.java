...
public class OpenApiController {
    ...
    public ResponseEntity<String> downloadOpenApiYaml() {
        try {
            ...
            String jsonContent = restTemplate.getForObject("http://localhost:8084/api-docs", String.class);
            ...
            headers.setContentDispositionFormData("attachment", "bff-service-openapi.yml");
